...
//Boyfriend Scary player types
enum
{
	BFS_ArcMain_Idle,
	BFS_ArcMain_Hit0,  //Left Down
	BFS_ArcMain_Miss0, //Left Down
	BFS_ArcMain_Hit1,  //Up Right
	BFS_ArcMain_Miss1, //Up Right
	BFS_ArcMain_Peace,
	BFS_ArcMain_Damage,
...
static const CharFrame char_bfs_frame[] = {
	{BFS_ArcMain_Idle, {  0,   0, 128, 128}, { 53,  92}}, //0 idle 1
	{BFS_ArcMain_Idle, {128,   0, 128, 128}, { 53,  93}}, //1 idle 2
	{BFS_ArcMain_Idle, {  0, 128, 128, 128}, { 53,  98}}, //2 idle 3
	{BFS_ArcMain_Idle, {128, 128, 128, 128}, { 53,  98}}, //3 idle 4
	
	{BFS_ArcMain_Hit0,  {  0,   0, 128, 128}, { 56,  94}}, //4 left 1
	{BFS_ArcMain_Hit0,  {128,   0, 128, 128}, { 56,  94}}, //5 left 2
	{BFS_ArcMain_Miss0, {  0,   0, 128, 128}, { 52, 102}}, //6 left miss 1
	{BFS_ArcMain_Miss0, {128,   0, 128, 128}, { 53, 102}}, //7 left miss 2
	
	{BFS_ArcMain_Hit0,  {  0, 128, 128, 128}, { 50,  82}}, //8 down 1
	{BFS_ArcMain_Hit0,  {128, 128, 128, 128}, { 50,  83}}, //9 down 2
	{BFS_ArcMain_Miss0, {  0, 128, 128, 128}, { 49,  90}}, //10 down miss 1
	{BFS_ArcMain_Miss0, {128, 128, 128, 128}, { 50,  90}}, //11 down miss 2
	
	{BFS_ArcMain_Hit1,  {  0,   0, 128, 128}, { 42, 103}}, //12 up 1
	{BFS_ArcMain_Hit1,  {128,   0, 128, 128}, { 44, 102}}, //13 up 2
	{BFS_ArcMain_Miss1, {  0,   0, 128, 128}, { 48,  99}}, //14 up miss 1
	{BFS_ArcMain_Miss1, {128,   0, 128, 128}, { 48, 100}}, //15 up miss 2
	
	{BFS_ArcMain_Hit1,  {  0, 128, 128, 128}, { 42,  94}}, //16 right 1
	{BFS_ArcMain_Hit1,  {128, 128, 128, 128}, { 42,  95}}, //17 right 2
	{BFS_ArcMain_Miss1, {  0, 128, 128, 128}, { 45, 102}}, //18 right miss 1
	{BFS_ArcMain_Miss1, {128, 128, 128, 128}, { 43, 102}}, //19 right miss 2
	
	{BFS_ArcMain_Peace, {  0,   0, 128, 128}, { 53,  98}}, //20 peace 1
	{BFS_ArcMain_Peace, {128,   0, 128, 128}, { 53,  97}}, //21 peace 2
	{BFS_ArcMain_Peace, {  0, 128, 128, 128}, { 53,  97}}, //22 peace 3

	{BFS_ArcMain_Damage, {  0,   0, 128, 128}, { 52,  102}}, //damage 1
	{BFS_ArcMain_Damage, {128,   0, 128, 128}, { 63,  106}}, //damage 2
	{BFS_ArcMain_Damage, {  0, 128, 128, 128}, { 40,  112}}, //damage 3
	{BFS_ArcMain_Damage, {128, 128, 128, 128}, { 53,  112}}, //damage 4
	
	{BFS_ArcMain_Dead0, {  0,   0, 128, 128}, { 53,  98}}, //23 dead0 0
	{BFS_ArcMain_Dead0, {128,   0, 128, 128}, { 53,  98}}, //24 dead0 1
	{BFS_ArcMain_Dead0, {  0, 128, 128, 128}, { 53,  98}}, //25 dead0 2
	{BFS_ArcMain_Dead0, {128, 128, 128, 128}, { 53,  98}}, //26 dead0 3
	
	{BFS_ArcDead_Dead1, {  0,   0, 128, 128}, { 53,  98}}, //27 dead1 0
	{BFS_ArcDead_Dead1, {128,   0, 128, 128}, { 53,  98}}, //28 dead1 1
	{BFS_ArcDead_Dead1, {  0, 128, 128, 128}, { 53,  98}}, //29 dead1 2
	{BFS_ArcDead_Dead1, {128, 128, 128, 128}, { 53,  98}}, //30 dead1 3
	
	{BFS_ArcDead_Dead2, {  0,   0, 128, 128}, { 53,  98}}, //31 dead2 body twitch 0
	{BFS_ArcDead_Dead2, {128,   0, 128, 128}, { 53,  98}}, //32 dead2 body twitch 1
	{BFS_ArcDead_Dead2, {  0, 128, 128, 128}, { 53,  98}}, //33 dead2 balls twitch 0
	{BFS_ArcDead_Dead2, {128, 128, 128, 128}, { 53,  98}}, //34 dead2 balls twitch 1
};
...
static const Animation char_bfs_anim[PlayerAnim_Max] = {
	...
	{2, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},        //Useless
	{2, (const u8[]){23, 24, 25, 26, ASCR_BACK, 1}},       //CharAnimDamage
	{2, (const u8[]){23, 24, 25, 26, ASCR_BACK, 1}},       //CharAnimDamage
	{2, (const u8[]){23, 24, 25, 26, ASCR_BACK, 1}},       //CharAnimDamage
	{2, (const u8[]){23, 24, 25, 26, ASCR_BACK, 1}},       //CharAnimDamage
	...
	{5, (const u8[]){23+4, 24+4, 25+4, 26+4, 26+4, 26+4, 26+4, 26+4, 26+4, 26+4, ASCR_CHGANI, PlayerAnim_Dead1}}, //PlayerAnim_Dead0
	{5, (const u8[]){26+4, ASCR_REPEAT}},                                                       //PlayerAnim_Dead1
	{3, (const u8[]){27+4, 28+4, 29+4, 30+4, 30+4, 30+4, 30+4, 30+4, 30+4, 30+4, ASCR_CHGANI, PlayerAnim_Dead3}}, //PlayerAnim_Dead2
	{3, (const u8[]){30+4, ASCR_REPEAT}},                                                       //PlayerAnim_Dead3
	{3, (const u8[]){31+4, 32+4, 30+4, 30+4, 30+4, 30+4, 30+4, ASCR_CHGANI, PlayerAnim_Dead3}},             //PlayerAnim_Dead4
	{3, (const u8[]){33+4, 34+4, 30+4, 30+4, 30+4, 30+4, 30+4, ASCR_CHGANI, PlayerAnim_Dead3}},             //PlayerAnim_Dead5
	
	{10, (const u8[]){30+4, 30+4, 30+4, ASCR_BACK, 1}}, //PlayerAnim_Dead4
	{ 3, (const u8[]){33+4, 34+4, 30+4, ASCR_REPEAT}},  //PlayerAnim_Dead5
};
