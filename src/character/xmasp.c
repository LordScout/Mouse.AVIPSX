...
static const Animation char_xmasp_anim[CharAnim_Max] = {
	...
	{2, (const u8[]){ 8, 9, 10, 11, ASCR_BACK, 3}},         //CharAnim_Left
	{0, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},
	{2, (const u8[]){ 12, 13, 14, 15, ASCR_BACK, 3}},         //CharAnim_Down
	{0, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},
	{2, (const u8[]){ 16, 17, 18, 19, ASCR_BACK, 3}},         //CharAnim_Up
	{0, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},
	{2, (const u8[]){ 20, 21, 22, 23, ASCR_BACK, 3}},         //CharAnim_Right
	{0, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},
};
